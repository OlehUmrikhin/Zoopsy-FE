      ...
      <div className="flex h-64 w-full items-center justify-center p-6">
        <div className="max-w-md rounded-3xl bg-red-50 p-8 text-center shadow-sm">
          ...
          <p className="text-red-600">
            Не вдалося завантажити дані дашборда. Перевірте підключення до сервера або права доступу.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="font-sans text-gray-800">
          <div className="mb-8 mt-2">
            ...
            <p className="mt-1 text-gray-500">Огляд ключових показників вашого сервісу за останній місяць.</p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
              <div>
                <div className="flex items-start justify-between">
                  <h3 className="text-xs font-bold tracking-wider text-gray-400 uppercase">ЗАГАЛОМ КОРИСТУВАЧІВ</h3>
                  <span className="rounded-full bg-green-100 px-2 py-1 text-xs font-bold text-green-700">+12%</span>
                </div>
                <p className="mt-2 text-3xl font-black text-gray-900">{formatNumber(data?.totalUsers)}</p>
              </div>
            ...
            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
              <div>
                <div className="flex items-start justify-between">
                  <h3 className="text-xs font-bold tracking-wider text-gray-400 uppercase">ДОХІД ЗА МІСЯЦЬ</h3>
                  <span className="rounded-full bg-green-100 px-2 py-1 text-xs font-bold text-green-700">+8.4%</span>
                </div>
                <p className="mt-2 text-3xl font-black text-gray-900">{formatCurrency(data?.monthlyRevenue)}</p>
              </div>
              <div className="mt-6 flex items-center gap-3">
                ...
                <span className="text-sm font-medium text-gray-500">+{data?.newTransactions || 0} нових транзакцій</span>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
              <div>
                <div className="flex items-start justify-between">
                  <h3 className="text-xs font-bold tracking-wider text-gray-400 uppercase">АКТИВНІ ПОСЛУГИ</h3>
                  <span className="rounded-full bg-blue-50 px-2 py-1 text-xs font-bold text-blue-600">В процесі</span>
                </div>
                <p className="mt-2 text-3xl font-black text-gray-900">{formatNumber(data?.activeServices)}</p>
              </div>
              <div className="mt-6">
                ...
                <p className="mt-2 text-xs font-medium text-gray-500">{data?.activeSitterShare || 0}% завантаженості сіттерів</p>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
              <div>
                <div className="flex items-start justify-between">
                  <h3 className="text-xs font-bold tracking-wider text-gray-400 uppercase">ВІДКРИТІ СКАРГИ</h3>
                  <span className="rounded-full bg-red-100 px-2 py-1 text-xs font-bold text-red-600">-5</span>
                </div>
