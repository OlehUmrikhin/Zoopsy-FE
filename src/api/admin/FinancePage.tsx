  ...
  return (
    <div className="font-sans text-zoopsy-dark-gray max-w-[1600px] mx-auto">
      <div className="mb-8 mt-2">
        <h2 className="text-3xl font-bold text-gray-900 font-plus-jakarta tracking-tight">Фінанси</h2>
        <p className="mt-1 text-zoopsy-gray font-inter">Огляд фінансових показників та транзакцій платформи</p>
      </div>
